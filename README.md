...
- 🔧 [**rook-agent-os-lite**](https://github.com/Mquarmoc/rook-agent-os-lite) — Agent coordination scaffolding (lite edition)
- 📚 [**openclaw-distillate-lite**](https://github.com/Mquarmoc/openclaw-distillate-lite) — OpenClaw framework summaries
- ⚡ [**relayouter**](https://github.com/Mquarmoc/relayouter) — High-performance assembly HTTP router
